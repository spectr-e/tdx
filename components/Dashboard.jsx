      ...
      <div className='grid mt-16 overflow-hidden border divide-x divide-y rounded-xl sm:grid-cols-2 lg:divide-y-0 lg:grid-cols-2 xl:grid-cols-2'>
          ...
          <div className='relative p-8 space-y-8'>
            ...
            <div className='space-y-2'>
              ...
              <p className='text-sm text-gray-600'>
                Designed to reinforce knowledge and assess understanding of book
                content, featuring instant feedback.
              </p>
            </div>
            <a
              href='#'
        ...
        <div className='relative group bg-white transition hover:z-[1] hover:shadow-2xl'>
          <div className='relative p-8 space-y-8'>
            ...
            <div className='space-y-2'>
              <h5 className='text-xl font-medium text-gray-800 '>Flashcards</h5>
              <p className='text-sm text-gray-600'>
